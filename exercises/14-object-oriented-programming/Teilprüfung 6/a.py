...
# Create book objects
book1 = Book("The Clockmaker's Paradox", "Amelia Roth", "Novel", 14.90)
book2 = Book("A Quiet Theory of Rain", "Jasper Lin", "Poetry", 11.50)
book3 = Book("Designing Tomorrow", "Mira Kessler", "Non-fiction", 22.30)
book4 = Book("Echoes of the Cedar Forest", "Daniel Arendt", "Novel", 9.80)
book5 = Book("The Invisible Ingredient", "Sofia Marek", "Non-fiction", 18.20)
book6 = Book("1984", "George Orwell", "Novel", 15.99)
...
print("\n=== Novels Only ===")
novels = inventory.search_category("Novel")
for novel in novels:
    print(novel)

# Calculate total price of novels
